...
import PySide6 as PyQt5
from PySide6.QtCore import QProcessEnvironment, QProcess, QLibraryInfo


def get_designer_path():
    """ get the path of qt designer """
    site_packages = "C:/Anaconda3/envs/wplace/Lib/site-packages"
    ...
    path = Path(f"{site_packages}/PySide6/{designer_name}")
    if not path.exists():
        raise Exception(
